...
LRU * lru_create (uint32_t capacity) {
    ...
    lru->list = (linked_list *) malloc(sizeof(linked_list));
...
bool delete_last_node(LRU * lru) {
    ...
    hashmap_remove(lru->reverse_lookup, (void *) curr_tail, sizeof(node *));
    free(curr_tail);
    return true;
}
...
void lru_driver () {
    ...
    lru_update(lru, (void *) "alpha", sizeof("alpha"), 55);
    lru_update(lru, (void *) "bravo", sizeof("bravo"), 72);
    lru_update(lru, (void *) "charlie", sizeof("charlie"), 88);
    lru_update(lru, (void *) "delta", sizeof("delta"), 43);
    lru_update(lru, (void *) "echo", sizeof("echo"), 669);
    lru_update(lru, (void *) "bravo", sizeof("bravo"), 134);
    lru_update(lru, (void *) "delta", sizeof("delta"), 777);
    /* lru_insert(lru, (void *) "alpha", sizeof("alpha"), 55); */
    /* lru_insert(lru, (void *) "bravo", sizeof("bravo"), 72); */
    /* lru_insert(lru, (void *) "charlie", sizeof("charlie"), 88); */
    /* lru_insert(lru, (void *) "delta", sizeof("delta"), 43); */
    int b2 = lru_get(lru, (void *) "bravo", sizeof("bravo"));
    lru_update(lru, (void *) "charlie", sizeof("charlie"), 45);
    int charlie = lru_get(lru, (void *) "charlie", sizeof("charlie"));
    lru_update(lru, (void *) "delta", sizeof("delta"), 73);
    int delta = lru_get(lru, (void *) "delta", sizeof("delta"));
    int echo = lru_get(lru, (void *) "echo", sizeof("echo"));
    printf("the value of the last node: %d\n", lru->list->tail->val);
    lru_update(lru, (void *) "golf", sizeof("golf"), 553);
    int golf = lru_get(lru, (void *) "golf", sizeof("golf"));
    printf("The head %d\n", lru->list->head->val);
    printf("Bravo: %d\n", b2);
    printf("Echo: %d\n", echo);
    printf("Charlie %d\n", charlie);
    printf("Delta: %d\n", delta);
    printf("Golf: %d\n", golf);
    printf("Alpha after deletion %d\n", lru_get(lru, (void *) "alpha", sizeof("alpha")));
    /* hashmap_remove(lru->reverse_lookup, (void *) lru_retrieve_node(lru, (void *) "delta", sizeof("delta")), sizeof(node *)); */
    lru_delete(lru, (void *) "delta", sizeof("delta"));
